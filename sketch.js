...
const easterEggIcon = 'icons/easterEgg_icon.png'
...
let spaceImage, birthdayImage, flameImage, snowImage, easterEggImage;
...
function retrieveLocalStorageItems(){
  const themeID = parseInt(localStorage.getItem("buttonID"))  || 0; 

  switch(themeID){
    case 0: 
      colors.PRIMARY_COLOR = "#930ff7";
      colors.SECONDARY_COLOR = "#ffffff";
      break;
    case 1: 
      colors.PRIMARY_COLOR = "#72ffd7";
      colors.SECONDARY_COLOR = "#ff5c5f";
      break;
    case 2: 
      colors.PRIMARY_COLOR = "#2192FF";
      colors.SECONDARY_COLOR = "#FF005C";
      break;
  }
}
...
function preload() {
  ...
  easterEggImage = loadImage('images/easteregg_image.png');
...
function draw() {
  ...
  if(isEasterEggActive){
    ...
    const easterEggUnlocked = boolean(localStorage.getItem('isEasterEggUnlocked')) || false;

    if(easterEggUnlocked){
      drawEasterEgg();
    } else if(!isEasterEggAlert){
      console.log(easterEggUnlocked)
      alert('Uw heeft de easteregg nog niet gevonden');
      isEasterEggAlert = true
    }
  }
...
class UI {
  ...
  setupUI() {
    ...
    // BIRTHDAY TEXT
    textSize(15);
    birthdayText = text("VERJAARDAG", canvasWidth - 80, 274);
    ...
    // EASTEREGG TEXT
    textSize(20);
    easterEggText = text('EasterEgg', canvasWidth - 80, 395)
    ...
    // CUSTOM FILTER TEXT
    textSize(22);
    customFiltersText = text("CUSTOM FILTERS", 10, 30);
    ...
    custom_filter_text_5 = text("PIXELSCHILD", 8, this.canvasHeight - 235);
  ...
  drawUIElements() {
    ...
    this.styleFilterButton(easterEggButton, easterEggIcon, 30, 25, colors.PRIMARY_COLOR);
  ...
  updateUIElements(canvasX) {
    ...
    easterEggButton.position(canvasX + this.canvasWidth - this.rectSideWidth + 10, 360);
...
function drawEasterEgg(){
  easterEggImage.resize(canvasWidth - rectSideWidth * 2, canvasHeight - rectHeight);
  image(easterEggImage, rectSideWidth, 0);
}
